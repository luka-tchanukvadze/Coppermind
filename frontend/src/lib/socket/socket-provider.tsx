...
// browser connects straight to the backend - Socket.IO uses its own /socket.io
// path, so it can't ride the Next /api rewrite. set NEXT_PUBLIC_SOCKET_URL in
// .env.local to match the backend host.
const SOCKET_URL =
